...
class profile extends CI_Controller {
    ...
    public function index() {
        ...
        $this->admin_layout->view('admission/profile/edit_profile', $data);
    }
    ...
    function updateProfile() {
        ...
        redirect(ADMISSION_URL . 'profile', 'refresh');
    }
    ...
    function changePassword() {
        $this->admin_layout->view('admission/profile/change_password');
    }
