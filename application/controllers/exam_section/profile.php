...
class profile extends CI_Controller {
    ...
    public function index() {
        ...
        $this->admin_layout->view('exam_section/profile/edit_profile', $data);
    }
    ...
    function updateProfile() {
        ...
        redirect(HOSTEL_URL . 'profile', 'refresh');
    }

    function changePassword() {
        $this->admin_layout->view('exam_section/profile/change_password');
    }
