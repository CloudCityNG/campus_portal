<script>
    ...
    $(document).ready(function() {
        $("#manage").validate({
            rules: {
                username: {
                    remote: '<?php echo HOSTEL_URL . 'profile/checkusername'; ?>'
                },
                email_address: {
                    remote: '<?php echo HOSTEL_URL . 'profile/checkemail'; ?>'
                }
            },
            messages: {
                username: {
    ...
    <form action="<?php echo HOSTEL_URL . 'profile/updateProfile' ?>" method="post" id="manage" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                ...
                <a href="<?php echo HOSTEL_URL; ?>" class="btn btn-inverse">Cancel</a>
            </div>
        </div>
