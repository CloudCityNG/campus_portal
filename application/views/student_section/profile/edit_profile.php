<script>
    ...
    $(document).ready(function() {
        $("#manage").validate({
            rules: {
                username: {
                    remote: '<?php echo STUDENT_SECTION_URL . 'profile/checkusername'; ?>'
                },
                email_address: {
                    remote: '<?php echo STUDENT_SECTION_URL . 'profile/checkemail'; ?>'
                }
            },
            messages: {
                username: {
...
<div class="col-md-12">
    ...
    <form action="<?php echo STUDENT_SECTION_URL . 'profile/updateProfile' ?>" method="post" id="manage" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                ...
                <a href="<?php echo STUDENT_SECTION_URL; ?>" class="btn btn-inverse">Cancel</a>
            </div>
        </div>
