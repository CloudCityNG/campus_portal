...
<div id="myTabContent" class="tab-content">
    <div class="tab-pane in active" id="basic_info">
        ...
        <form action="<?php echo ADMISSION_URL . 'forms/update_ug_basic/' . $student_id; ?>" method="post" class="form-horizontal info_basic">
    ...
    <div class="tab-pane in active" id="edu_info">
        ...
        <form action="<?php echo ADMISSION_URL . 'forms/update_ug_education/' . $student_id ?>" method="post" class="form-horizontal info_basic">
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="ssc_from_date" id="ssc_from_date" value="<?php echo date('d-m-Y', strtotime(@$edu_master_info[1]->from_date)); ?>" class="form-control required"/></td>
                        <td><input type="text" name="ssc_to_date" id="ssc_to_date" value="<?php echo date('d-m-Y', strtotime(@$edu_master_info[1]->to_date)); ?>" class="form-control required"/></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="hsc_from_date" id="hsc_from_date" value="<?php echo date('d-m-Y', strtotime(@$edu_master_info[0]->from_date)); ?>" class="form-control required"/></td>
                        <td><input type="text" name="hsc_to_date" id="hsc_to_date" value="<?php echo date('d-m-Y', strtotime(@$edu_master_info[0]->to_date)); ?>" class="form-control required"/></td>
                ...
                <table  id="edu_details" class="table table-bordered table-responsive">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="max_theory_marks[]" value="<?php echo getMarks(@$edu_master_info[0]->edu_master_id, 'Physics', 'theory_max_mark'); ?>" class="form-control text-center"/></td>
                        <td><input type="text" name="min_theroy_marks[]" value="<?php echo getMarks(@$edu_master_info[0]->edu_master_id, 'Physics', 'theory_min_mark'); ?>" class="form-control text-center"/></td>
                        <td><input type="text" name="max_pratical_marks[]" value="<?php echo getMarks(@$edu_master_info[0]->edu_master_id, 'Physics', 'pratical_max_mark'); ?>" class="form-control text-center"/></td>
                        <td><input type="text" name="min_pratical_marks[]" value="<?php echo getMarks(@$edu_master_info[0]->edu_master_id, 'Physics', 'pratical_min_mark'); ?>" class="form-control text-center"/></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="max_theory_marks[]" value="<?php echo getMarks(@$edu_master_info[0]->edu_master_id, 'Biology', 'theory_max_mark'); ?>" class="form-control text-center"/></td>
                        <td><input type="text" name="min_theroy_marks[]" value="<?php echo getMarks(@$edu_master_info[0]->edu_master_id, 'Biology', 'theory_min_mark'); ?>" class="form-control text-center"/></td>
                        <td><input type="text" name="max_pratical_marks[]" value="<?php echo getMarks(@$edu_master_info[0]->edu_master_id, 'Biology', 'pratical_max_mark'); ?>" class="form-control text-center"/></td>
                        <td><input type="text" name="min_pratical_marks[]" value="<?php echo getMarks(@$edu_master_info[0]->edu_master_id, 'Biology', 'pratical_min_mark'); ?>" class="form-control text-center"/></td>
                    </tr>
    ...
    <div class="tab-pane in active" id="languages">
        ...
        <form action="<?php echo ADMISSION_URL . 'forms/update_ug_language/' . $student_id ?>" method="post" class="form-horizontal info_basic">
            <table class="table table-bordered table-responsive">
                <tr>
    ...
    <div class="tab-pane in active" id="foreign_detials">
        ...
        <form action="<?php echo ADMISSION_URL . 'forms/update_ug_foreign/' . $student_id ?>" method="post" class="form-horizontal">
            <div class = "form-group">
                <label for = "question" class = "col-md-2 control-label">
            ...
            <div class = "form-group">
                ...
                <div class = "col-md-10">
                    <input type="text" name="expire_date"  value="<?php echo @$foreign_info[0]->issue; ?>" class="form-control required" placeholder = "dd-mm-yyyy" />
                </div>
            </div>
    ...
    <div class="tab-pane in active" id="require_doc">
        ...
        <form action="<?php echo ADMISSION_URL . 'forms/update_ug_images/' . $student_id ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
            <div class = "form-group">
                <label for = "question" class = "col-md-2 control-label">
                    Student Image
                    <span class="text-danger">*</span>
                ...
                <div class = "col-md-2">
                    <a data-target="#view_image" data-toggle="modal" href="<?php echo ADMISSION_URL . 'forms/view_image/' . $student_id . '/student_image'; ?>" class="btn btn-default">Current Image</a>
                </div>
            </div>
            ...
            <div class = "form-group">
                ...
                <div class = "col-md-2">
                    <a data-target="#view_image" data-toggle="modal" href="<?php echo ADMISSION_URL . 'forms/view_image/' . $student_id . '/sign'; ?>" class="btn btn-default">Current Image</a>
                </div>
            </div>
            ...
            <div class = "form-group">
                ...
                <div class = "col-md-2">
                    <a data-target="#view_image" data-toggle="modal" href="<?php echo ADMISSION_URL . 'forms/view_image/' . $student_id . '/ssc_marksheet'; ?>" class="btn btn-default">Current Image</a>
                </div>
            </div>
            ...
            <div class = "form-group">
                ...
                <div class = "col-md-8">
                    <input type="file" name="hsc_marksheet" class="form-control required"/>
                </div>
                <div class = "col-md-2">
                    <a data-target="#view_image" data-toggle="modal" href="<?php echo ADMISSION_URL . 'forms/view_image/' . $student_id . '/hsc_marksheet'; ?>" class="btn btn-default">Current Image</a>
                </div>
            </div>
            ...
            <div class = "form-group">
                ...
                <div class = "col-md-8">
                    <input type="file" name="migration_certificate" class="form-control required"/>
                </div>
                <div class = "col-md-2">
                    <a data-target="#view_image" data-toggle="modal" href="<?php echo ADMISSION_URL . 'forms/view_image/' . $student_id . '/migration_certificate'; ?>" class="btn btn-default">Current Image</a>
                </div>
            </div>
            ...
            <div class = "form-group">
                ...
                <div class = "col-md-8">
                    <input type="file" name="leaving_certificate" class="form-control required"/>
                </div>
                <div class = "col-md-2">
                    <a data-target="#view_image" data-toggle="modal" href="<?php echo ADMISSION_URL . 'forms/view_image/' . $student_id . '/leaving_certificate'; ?>" class="btn btn-default">Current Image</a>
                </div>
            </div>
            ...
            <div class = "form-group">
                ...
                <div class = "col-md-8">
                    <input type="file" name="cast_certificate" class="form-control required"/>
                </div>
                <div class = "col-md-2">
                    <a data-target="#view_image" data-toggle="modal" href="<?php echo ADMISSION_URL . 'forms/view_image/' . $student_id . '/cast_certificate'; ?>" class="btn btn-default">Current Image</a>
                </div>
            </div>
            ...
            <div class = "form-group">
                ...
                <div class = "col-md-8">
                    <input type="file" name="aids_certificate" class="form-control required"/>
                </div>
                <div class = "col-md-2">
                    <a data-target="#view_image" data-toggle="modal" href="<?php echo ADMISSION_URL . 'forms/view_image/' . $student_id . '/aids_certificate'; ?>" class="btn btn-default">Current Image</a>
                </div>
            </div>
