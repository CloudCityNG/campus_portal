<script>
    ...
    $(document).ready(function() {
        $("#manage").validate({
            rules: {
                username: {
                    remote: '<?php echo ADMISSION_URL . 'profile/checkusername'; ?>'
                },
                email_address: {
                    remote: '<?php echo ADMISSION_URL . 'profile/checkemail'; ?>'
                }
            },
            messages: {
                username: {
...
<div class="col-md-12">
    ...
    <form action="<?php echo ADMISSION_URL . 'profile/updateProfile' ?>" method="post" id="manage" class="form-horizontal">
