<script>
    ...
    $(document).ready(function() {
        $("#manage").validate({
            rules: {
                old_password: {
                    remote: '<?php echo ADMISSION_URL . 'profile/checkOldPassword'; ?>'
                },
                confirm_password: {
                    equalTo: "#password"
                }
...
<div class="col-md-12">
    ...
    <form action="<?php echo ADMISSION_URL . 'profile/updatePassword' ?>" method="post" id="manage" class="form-horizontal">
