...
<html>
    <head>
        ...
        <script type="text/javascript">
            var http_host_js = '<?php echo EXAM_SECTION_URL; ?>';
        </script>
    </head>
    <body>
        <div class="container">
                ...
                <div class="container padding-killer">
                    <div class="project-logo-area">
                        ...
                        <div class="col-md-6 text-center cursive-font">
                            <h3>Campus Portal</h3>
                            <h2>E<span class="text-muted">xam</span> S<span class="text-muted">ection</span></h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <ul class="nav navbar-nav pull-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo EXAM_SECTION_URL . 'profile'; ?>">Edit Profile</a></li>
                                <li><a href="<?php echo EXAM_SECTION_URL . 'change_password'; ?>">Change Password</a></li>
